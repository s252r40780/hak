...
background2 = transform.scale(image.load('bg2.jpg'), (win_width, win_height))
...
# Отрисовка Эльфов23
enemy1 = Enemy('elf.png', 1, 100, 75, 75, )
...
while game:
    ...
    if not finish:
        ...
        enemy3 = transform.scale(image.load("elf.png"), (50,50))
        window.blit(enemy3, (700,300))
        

        quest1 = font2.render(f"1-спросить Джейкоба 3-спросить Луну", True, (255, 0, 0),(0,0,0))
        background.blit(quest1, (50, 10))

        if keys[K_1]:
            answ1 = font1.render(f'я - Джейкоб и мы сейчас находимся на тропинке к замку, если ты туда идешь то иди на право',True, (255, 255, 255), (0, 0, 0))
            background.blit(answ1, (60, 590))

        if keys[K_2]:
            answ2 = font1.render(f'''Меня зовут Луна, и я - эльф, если ты идешь к замку то удачи''',True, (255, 255, 255), (0, 0, 0))
            answ3 = font1.render(f'''Вокруг нас воцарилась тишина, только слабый ветер шепчет свои таинственные истории...''',True, (255, 255, 255), (0, 0, 0))
        ...
        if player_x > 700:
            answ7 = font1.render(f'Эй парень, погоди, подойди ко мне', True,(0,0,0),(255,255,255))
            background.blit(answ7,(100, 430))
            
        if player_x < 300:
            answ8 = font1.render(f'Ты ведь идешь к замку, верно?', True,(0,0,0),(255,255,255))
            background.blit(answ8,(100, 430))
            answ7 = font1.render(f'', True,(0,0,0))
            background.blit(answ7,(1000, 500))
            
        if player_x< 300:
            quest1 = font2.render(f"", True, (255, 0, 0))
            background.blit(quest1, (50, 10))

        if player_x < 300:
            answ9 = font2.render(f'1 - Да 2 - Нет', True,(0,0,0),(255,255,255))
            background.blit(answ9,(50, 10))
        ...
        if player_x > 1000:
            ...
            if player_x > 700:
                answ5 = font1.render(f'', True,(0,0,0))
                background.blit(answ5,(1,1))
            if player_x > 700 and player_x < 900:
                answ6 = font1.render(f'', True,(0,0,0),(255,255,255))
                background.blit(answ6,(1,1))
            
            answ6 = font1.render(f'', True,(0,0,0))
            background.blit(answ6,(1, 1))
            answ2 = font1.render(f'',True, (255, 255, 255))
            answ3 = font1.render(f'',True, (255, 255, 255))
            background.blit(answ2, (1,1))
            background.blit(answ3, (1,1))
            player_x = 200
            player_y = 200
            enemy1.kill()
            #enemy2.kill()
